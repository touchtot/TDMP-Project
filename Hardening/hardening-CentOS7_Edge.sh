...
echo "server 10.18.12.1 prefer" >> /etc/ntp.conf
...
useradd tdg-emeruser
echo "7H3QDCabRh@UNNCq" | passwd emer --stdin
chage -m 0 -M 99999 -I -1 -E -1 emer
useradd pamuser
echo "kH9z$bCYt#8t" | passwd pamuser --stdin

#----- Set sudoers -----
echo "cdnedge ALL=(ALL) ALL" >> /etc/sudoers
echo "pamuser ALL=(ALL) ALL" >> /etc/sudoers
echo "tdg-emeruser ALL=(ALL) ALL" >> /etc/sudoers
...
# increases the part of qulays is warning to report 
